...
fclose($log); 
echo "<font color=red>Please, don't abuse with malicious code! Don't enter special characters (like slashes) and other symbols! If you search website, then write only the name of website without http:// or other symbols! Thnx!</font>"; 
exit;
}
?>
...
<tr>
<td bgcolor="#FFFFFF">
<div class="post"><h2><a href="http://<?php echo htmlspecialchars(clean_url($rows['detail'])); ?>" target="_blank"><img src="http://images.shrinktheweb.com/xino.php?stwembed=1&stwaccesskeyid=93e93e229a837b8&stwsize=xlg&stwurl=<?php echo htmlspecialchars($rows['detail']); ?>" title="<?php echo htmlspecialchars($rows['detail']); ?>"/><br /><?php echo htmlspecialchars($rows['detail']); ?></a></h2><p class="byline"><small>
...
echo '<br /><a href="http://whatcms.bl.ee/search.php?key='.htmlspecialchars(clean_url($rows['detail'])).'" target="_blank"> View What CMS is</a>';
